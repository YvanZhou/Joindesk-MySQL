...
public class IssueController {
    ...
    public String addIssue(@RequestBody Issue issue, @PathVariable("project_id") Long projectID, @RequestParam(name = "parent_issue_key", required = false) Long parentIssueKey) {
        if (parentIssueKey != null) {
            return HelperUtil.squiggly("base,issue_detail,audit_details", issueService.createSubIssue(issue, projectID, parentIssueKey));
        }
